  ...
  return (
    <ChartContext.Provider value={{ config }}>
      <div
        ...
        data-chart={chartId}
        className={cn(
          "[&_.recharts-cartesian-axis-tick_text]:fill-muted-foreground flex aspect-video justify-center text-xs [&_.recharts-layer]:outline-hidden",
          className
        )}
        {...props}
      >
...
function getPayloadConfigFromPayload(config: ChartConfig, payload: any, key: string) {
  ...
  const labelKey = inner[key] || payload[key];
  return config[labelKey as keyof typeof config] || config[key];
}
